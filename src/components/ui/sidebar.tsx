    ...
    >
      ...
      >
        <div
          ...
          className="relative bg-sidebar group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {side === "left" ? (
            <ChevronRightIcon
              role="button"
              ...
              tabIndex={0}
              className={cn(
                "absolute top-1/2 -translate-y-1/2 z-20 h-5 w-5 cursor-pointer",
                "rounded-full bg-background/70 backdrop-blur-sm",
                "hover:bg-accent hover:text-accent-foreground hover:shadow-md hover:scale-110 transition-all",
                "-right-2 translate-x-1/5"
              )}
            />
          ) : (
            <ChevronLeftIcon
